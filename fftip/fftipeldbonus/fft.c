#include"fft.h"
void FFTipfn(float _Complex FFT_input[FFTSIZE], float _Complex FFT_output[FFTSIZE])
{
#pragma HLS INTERFACE axis register both port=FFT_output
#pragma HLS INTERFACE axis register both port=FFT_input
