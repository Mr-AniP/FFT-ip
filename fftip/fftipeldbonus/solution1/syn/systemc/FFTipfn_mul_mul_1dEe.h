...
// ==============================================================
#ifndef __FFTipfn_mul_mul_1dEe__HH__
#define __FFTipfn_mul_mul_1dEe__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(FFTipfn_mul_mul_1dEe) {
    ...
    SC_CTOR(FFTipfn_mul_mul_1dEe):  ACMP_smul_uu_U ("ACMP_smul_uu_U") {
