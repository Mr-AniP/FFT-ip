...
// ==============================================================
#ifndef __FFTipfn_faddfsub_bkb__HH__
#define __FFTipfn_faddfsub_bkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(FFTipfn_faddfsub_bkb) {
    ...
    SC_CTOR(FFTipfn_faddfsub_bkb):  ACMP_faddfsub_U ("ACMP_faddfsub_U") {
