...
set DataType00 "[list complex "float" ]"
...
set DataType0 [list "com" "struct com" $structMem0 1 0 $structParameter0 $structArgument0 $NameSpace0 $structIsPacked0]
set Port0 [list $PortName0 $Interface0 $DataType0 $Pointer0 $Dims0 $Const0 $Volatile0 $ArrayOpt0]
lappend PortList $Port0
set PortName1 "FFTOUT"
set BitWidth1 "96"
set ArrayOpt1 ""
set Const1 "0"
set Volatile1 "0"
...
set DataType10 "[list complex "float" ]"
...
set DataType1 [list "com" "struct com" $structMem1 1 0 $structParameter1 $structArgument1 $NameSpace1 $structIsPacked1]
