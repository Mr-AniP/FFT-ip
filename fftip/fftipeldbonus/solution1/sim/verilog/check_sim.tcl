...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.FFTipfn.autotvin_FFTIN_V_data.dat"
         "c.FFTipfn.autotvin_FFTIN_V_last_V.dat"
         "c.FFTipfn.autotvin_FFTIN_V_keep_V.dat"
         "c.FFTipfn.autotvin_FFTOUT_V_data.dat"
         "c.FFTipfn.autotvin_FFTOUT_V_last_V.dat"
         "c.FFTipfn.autotvin_FFTOUT_V_keep_V.dat"
         "c.FFTipfn.autotvout_FFTOUT_V_data.dat"
         "c.FFTipfn.autotvout_FFTOUT_V_last_V.dat"
         "c.FFTipfn.autotvout_FFTOUT_V_keep_V.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.FFTipfn.autotvout_FFTOUT_V_data.dat"
         "rtl.FFTipfn.autotvout_FFTOUT_V_last_V.dat"
         "rtl.FFTipfn.autotvout_FFTOUT_V_keep_V.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
