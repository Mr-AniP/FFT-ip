...
# ==============================================================
set ::env(PATH) "$::env(PATH);E:/xilinx/Vivado/2019.1/win64/tools/fpo_v7_0"
set ::env(PATH) "$::env(PATH);E:/xilinx/Vivado/2019.1/win64/tools/opencv"
set ::env(PATH) "$::env(PATH);E:/xilinx/Vivado/2019.1/win64/tools/fft_v9_1"
set ::env(PATH) "$::env(PATH);E:/xilinx/Vivado/2019.1/win64/tools/fir_v7_0"
set ::env(PATH) "$::env(PATH);E:/xilinx/Vivado/2019.1/win64/tools/dds_v6_0"
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "FFTipfn.autotvin.dat"
	set constFileTvOut       "FFTipfn.autotvout.dat"
	set constFileHdlTvIn     "FFTipfn.autohdltvin.dat"
	set constFileHdlTvOut    "FFTipfn.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
