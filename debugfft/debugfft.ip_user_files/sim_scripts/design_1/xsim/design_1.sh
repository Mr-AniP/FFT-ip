...
simulate()
{
  xsim design_1 -key {Behavioral:sim_1:Functional:design_1} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_ae83.protoinst" -protoinst "protoinst_files/bd_68b9.protoinst" -protoinst "protoinst_files/design_1.protoinst" -log simulate.log
}
